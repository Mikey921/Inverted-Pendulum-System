...
/*宏定义参数*/
#define CENTER_ANGLE		2020		//中心角度值
...
volatile uint8_t g_send_flag = 0;
...
void TIM1_UP_IRQHandler(void)
{
	...
	static uint16_t Count0, Count1, Count2, Count3, CountTime;	//分别用于判断状态、角度环、位置环和计数计时的计次分频
